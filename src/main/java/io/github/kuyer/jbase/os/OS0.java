package io.github.kuyer.jbase.os;
...
public class OS0 {
	...
	private List<Integer> imgByteToWrite = new ArrayList<Integer>();
	...
	public void makeFllopy()   {
        try {
            DataOutputStream out = new DataOutputStream(new FileOutputStream("D:\\Hosts\\imgs\\hhos.img"));
	...
	public static void main(String[] args) {
		OS0 os0 = new OS0("Hello, this is YunHangOS!");
		os0.makeFllopy();
	}
